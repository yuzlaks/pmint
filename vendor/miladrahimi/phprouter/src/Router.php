...
class Router
{
    ...
    public function resource(string $path, $controller): void
    {
        global $router;

        $router->get("$path",[$controller,'index']);
        $router->get("create-$path",[$controller,'create']);
        $router->post("store-$path",[$controller,'store']);
        $router->get("edit-$path/{id}",[$controller,'edit']);
        $router->post("update-$path/{id}",[$controller,'update']);
        $router->get("delete-$path/{id}",[$controller,'delete']);
